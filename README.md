...
이전에 백준을 풀었던 것을 오랜만에 들어와 보니 신기하다 이렇게 매일 메모를 남겼었던 기억도 새록새록 나는 것 같다 아직도 백준 문제를 많이 풀고있지만 깃허브에는 올리지 않고 블로그에 업로드를 한다 모든 문제를 업로드 하지는 않지만 간단하더라도 고민했던 문제들은 메모를 남겨서 기록해 놓고 있다<br>
